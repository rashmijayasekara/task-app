...
public class ProjectController {
    ...
    public ProjectDTO createNewProject(@Validated(ValidationGroups.Create.class)  @RequestBody ProjectDTO projectDTO, @AuthenticationPrincipal(expression = "username") String username){
    ...
    public ProjectDTO getProject(@PathVariable Integer projectId,@AuthenticationPrincipal(expression = "username") String username){
    ...
    public void renameProject(@PathVariable int projectId, @Validated @RequestBody ProjectDTO projectDTO, @AuthenticationPrincipal(expression = "username") String username){
    ...
    public void deleteProject(@PathVariable int projectId, @AuthenticationPrincipal(expression = "username") String username){
