...
public class ProjectController {
    ...
    public ProjectDTO createNewProject(@Validated(ValidationGroups.Create.class)  @RequestBody ProjectDTO projectDTO, @RequestAttribute String username){
    ...
    public void renameProject(@PathVariable int projectId, @Validated @RequestBody ProjectDTO projectDTO, @RequestAttribute String username){
